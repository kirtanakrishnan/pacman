    ...
    while not frontier.isEmpty():
        ...
        if currentState not in explored:
            ...
            if problem.isGoalState(currentState):
                ...
                for nextState, action, stepCost in successorNodes:
...
def uniformCostSearch(problem: SearchProblem):
    ...
    while not frontier.isEmpty():
        ...
        if (currentState not in explored) or (currentCost < explored[currentState]):
    ...
    while not frontier.isEmpty():
        ...
        if problem.isGoalState(currentState):
            ...
            for nextState, action, stepCost in successorNodes:
                ...
                nextCost = problem.getCostOfActions(newAction)
                nextNode = (nextState, newAction, nextCost)

                previously_explored = False
                for node in explored:

                    exploredState, exploredCost = node

                    if (nextState == exploredState) and (nextCost >= exploredCost):
                        previously_explored = True

                if not previously_explored:
                    frontier.push(nextNode, nextCost + heuristic(nextState, problem))
                    explored.append((nextState, nextCost))
